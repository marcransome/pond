...
@echo "pond disable: failure tests for disabled pond"
...
@test "pond disable: command error shown for disabled pond" (pond disable $pond_name 2>&1 | string collect) = "Pond already disabled: $pond_name"
__pond_tear_down
...
@test "pond disable: command error shown for disabled pond" (pond disable $pond_name_prefix-1 $pond_name_prefix-2 $pond_name_prefix-3 2>&1 | string collect) = "Pond already disabled: $pond_name_prefix-1"
__pond_tear_down
