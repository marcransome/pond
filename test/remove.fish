...
@echo 'pond remove: success tests'
__pond_setup
...
@echo 'pond remove: failure exit code tests'
__pond_setup
...
@echo 'pond remove: failure usage output tests'
__pond_setup
...
@test 'pond remove: command error shown for non-existent pond' (pond remove non-exist 2>&1 | string collect) = "Pond does not exist: non-exist"
__pond_tear_down
