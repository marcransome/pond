...
complete -c pond -n "__fish_seen_subcommand_from rm remove enable disable status; and not __fish_seen_subcommand_from var variable" -a "(pond list 2>/dev/null || echo)"
