...
set -g pond_enable_on_create yes
set -g pond_load_on_create yes
@echo "pond create $pond_name: success tests for single pond (loaded and enabled)"
@test "setup: pond_enable_on_create yes" (echo $pond_enable_on_create) = "yes"
@test "setup: pond_load_on_create yes"  (echo $pond_load_on_create) = "yes"
...
@echo "pond create $pond_name: output tests for single pond (loaded and enabled)"
@test "setup: pond_enable_on_create yes" (echo $pond_enable_on_create) = "yes"
@test "setup: pond_load_on_create yes"  (echo $pond_load_on_create) = "yes"
...
set -g pond_enable_on_create no
set -g pond_load_on_create yes
@echo "pond create $pond_name: success tests for single pond (loaded only)"
@test "setup: pond_enable_on_create no" (echo $pond_enable_on_create) = "no"
@test "setup: pond_load_on_create yes"  (echo $pond_load_on_create) = "yes"
@test "pond create: success exit code" (pond create $pond_name >/dev/null 2>&1) $status -eq $success
@test "pond create: pond directory created" -d $pond_home/$pond_name
@test "pond create: got pond name in event" (echo $event_pond_names) = $pond_name
...
@echo "pond create $pond_name: output tests for single pond (loaded only)"
@test "setup: pond_enable_on_create no" (echo $pond_enable_on_create) = "no"
@test "setup: pond_load_on_create yes"  (echo $pond_load_on_create) = "yes"
@test "pond create: output message correct" (pond create $pond_name 2>&1) = $success_output_single_pond
__pond_tear_down
...
set -g pond_enable_on_create yes
set -g pond_load_on_create no
@echo "pond create $pond_name: success tests for single pond (enabled only)"
@test "setup: pond_enable_on_create yes" (echo $pond_enable_on_create) = "yes"
@test "setup: pond_load_on_create no"  (echo $pond_load_on_create) = "no"
@test "pond create: success exit code" (pond create $pond_name >/dev/null 2>&1) $status -eq $success
@test "pond create: pond directory created" -d $pond_home/$pond_name
@test "pond create: got pond name in event" (echo $event_pond_names) = $pond_name
@test "pond create: got pond path in event" (echo $event_pond_paths) = $pond_home/$pond_name
...
@echo "pond create $pond_name: output tests for single pond (enabled only)"
@test "setup: pond_enable_on_create yes" (echo $pond_enable_on_create) = "yes"
@test "setup: pond_load_on_create no"  (echo $pond_load_on_create) = "no"
@test "pond create: output message correct" (pond create $pond_name 2>&1) = $success_output_single_pond
__pond_tear_down
...
set -g pond_enable_on_create yes
set -g pond_load_on_create yes
@echo "pond create $pond_name_prefix-1 $pond_name_prefix-2 $pond_name_prefix-3: success tests for multiple ponds (loaded and enabled)"
@test "setup: pond_enable_on_create yes" (echo $pond_enable_on_create) = "yes"
@test "setup: pond_load_on_create yes"  (echo $pond_load_on_create) = "yes"
...
@test "pond create: $pond_name_prefix-1 enabled" (contains $pond_home/$pond_name_prefix-1 $pond_function_path) $status -eq $success
@test "pond create: $pond_name_prefix-1 loaded" (contains $pond_home/$pond_name_prefix-1 $fish_function_path) $status -eq $success
@test "pond create: $pond_name_prefix-2 enabled" (contains $pond_home/$pond_name_prefix-2 $pond_function_path) $status -eq $success
@test "pond create: $pond_name_prefix-2 loaded" (contains $pond_home/$pond_name_prefix-2 $fish_function_path) $status -eq $success
@test "pond create: $pond_name_prefix-3 enabled" (contains $pond_home/$pond_name_prefix-3 $pond_function_path) $status -eq $success
@test "pond create: $pond_name_prefix-3 loaded" (contains $pond_home/$pond_name_prefix-3 $fish_function_path) $status -eq $success
__pond_tear_down
__pond_event_reset

@echo "pond create $pond_name_prefix-1 $pond_name_prefix-2 $pond_name_prefix-3: output tests for multiple ponds (loaded and enabled)"
@test "setup: pond_enable_on_create yes" (echo $pond_enable_on_create) = "yes"
@test "setup: pond_load_on_create yes"  (echo $pond_load_on_create) = "yes"
...
set -g pond_enable_on_create no
set -g pond_load_on_create yes
@echo "pond create $pond_name_prefix-1 $pond_name_prefix-2 $pond_name_prefix-3: success tests for multiple ponds (loaded only)"
@test "setup: pond_enable_on_create no" (echo $pond_enable_on_create) = "no"
@test "setup: pond_load_on_create yes"  (echo $pond_load_on_create) = "yes"
@test "pond create: success exit code" (pond create $pond_name_prefix-1 $pond_name_prefix-2 $pond_name_prefix-3 >/dev/null 2>&1) $status -eq $success
@test "pond create: pond directory created" -d $pond_home/$pond_name_prefix-1
...
@test "pond create: got pond names in events" (echo $event_pond_names) = "$pond_name_prefix-1 $pond_name_prefix-2 $pond_name_prefix-3"
@test "pond create: got pond paths in events" (echo $event_pond_paths) = "$pond_home/$pond_name_prefix-1 $pond_home/$pond_name_prefix-2 $pond_home/$pond_name_prefix-3"
@test "pond create: $pond_name_prefix-1 enabled" (not contains $pond_home/$pond_name_prefix-1 $pond_function_path) $status -eq $success
@test "pond create: $pond_name_prefix-1 loaded" (contains $pond_home/$pond_name_prefix-1 $fish_function_path) $status -eq $success
@test "pond create: $pond_name_prefix-2 enabled" (not contains $pond_home/$pond_name_prefix-2 $pond_function_path) $status -eq $success
@test "pond create: $pond_name_prefix-2 loaded" (contains $pond_home/$pond_name_prefix-2 $fish_function_path) $status -eq $success
@test "pond create: $pond_name_prefix-3 enabled" (not contains $pond_home/$pond_name_prefix-3 $pond_function_path) $status -eq $success
@test "pond create: $pond_name_prefix-3 loaded" (contains $pond_home/$pond_name_prefix-3 $fish_function_path) $status -eq $success
__pond_tear_down
__pond_event_reset

@echo "pond create $pond_name_prefix-1 $pond_name_prefix-2 $pond_name_prefix-3: output tests for multiple ponds (loaded only)"
@test "setup: pond_enable_on_create no" (echo $pond_enable_on_create) = "no"
@test "setup: pond_load_on_create yes"  (echo $pond_load_on_create) = "yes"
@test "pond create: success output message" (pond create $pond_name_prefix-1 $pond_name_prefix-2 $pond_name_prefix-3 2>&1 | string collect) = $success_output_multiple_ponds
__pond_tear_down
...
set -g pond_enable_on_create yes
set -g pond_load_on_create no
@echo "pond create $pond_name_prefix-1 $pond_name_prefix-2 $pond_name_prefix-3: success tests for multiple ponds (enabled only)"
@test "setup: pond_enable_on_create yes" (echo $pond_enable_on_create) = "yes"
@test "setup: pond_load_on_create no"  (echo $pond_load_on_create) = "no"
@test "pond create: success exit code" (pond create $pond_name_prefix-1 $pond_name_prefix-2 $pond_name_prefix-3 >/dev/null 2>&1) $status -eq $success
@test "pond create: pond directory created" -d $pond_home/$pond_name_prefix-1
...
@test "pond create: got pond paths in events" (echo $event_pond_paths) = "$pond_home/$pond_name_prefix-1 $pond_home/$pond_name_prefix-2 $pond_home/$pond_name_prefix-3"
@test "pond create: $pond_name_prefix-1 enabled" (contains $pond_home/$pond_name_prefix-1 $pond_function_path) $status -eq $success
@test "pond create: $pond_name_prefix-1 loaded" (not contains $pond_home/$pond_name_prefix-1 $fish_function_path) $status -eq $success
@test "pond create: $pond_name_prefix-2 enabled" (contains $pond_home/$pond_name_prefix-2 $pond_function_path) $status -eq $success
@test "pond create: $pond_name_prefix-2 loaded" (not contains $pond_home/$pond_name_prefix-2 $fish_function_path) $status -eq $success
@test "pond create: $pond_name_prefix-3 enabled" (contains $pond_home/$pond_name_prefix-3 $pond_function_path) $status -eq $success
@test "pond create: $pond_name_prefix-3 loaded" (not contains $pond_home/$pond_name_prefix-3 $fish_function_path) $status -eq $success
__pond_tear_down
__pond_event_reset

@echo "pond create $pond_name_prefix-1 $pond_name_prefix-2 $pond_name_prefix-3: output tests for multiple ponds (enabled only)"
@test "setup: pond_enable_on_create yes" (echo $pond_enable_on_create) = "yes"
@test "setup: pond_load_on_create no"  (echo $pond_load_on_create) = "no"
@test "pond create: success output message" (pond create $pond_name_prefix-1 $pond_name_prefix-2 $pond_name_prefix-3 2>&1 | string collect) = $success_output_multiple_ponds
__pond_tear_down
