...
@echo "pond deinit $pond_name: success tests for pond without deinit function"
...
@echo "pond deinit $pond_name: output tests for pond without deinit function"
__pond_setup 1 enabled unpopulated
__pond_editor_intercept_with __pond_test_deinit_editor
...
@echo "pond deinit $pond_name: success tests for pond with existing deinit function"
...
@echo "pond deinit $pond_name: output tests for pond with existing deinit function"
__pond_setup 1 enabled populated
__pond_editor_intercept_with __pond_test_deinit_editor
